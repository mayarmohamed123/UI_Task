        ...
        function updateButtonStates() {
            ...
            if (nextBtn) {
                ...
                if (isLast && !window.IS_HEAD && (revealedCount < window.totalQuestions)) {
                    nextBtn.innerHTML = 'بانتظار إظهار الأسئلة... <i class="fas fa-lock ml-2"></i>';
                    ...
                    if (isLast) {
                        ...
                        if (window.nextFieldName) {
                            nextBtn.innerHTML = `حفظ والانتقال لمجال ${window.nextFieldName} <i class="fas fa-save ml-2"></i>`;
                        } else {
                            nextBtn.innerHTML = 'إنهاء وحفظ <i class="fas fa-save ml-2"></i>';
                        }
                    } else {
                        nextBtn.innerHTML = 'التالي <i class="fas fa-arrow-left ml-2"></i>';
                    }
                }
            }
        }
